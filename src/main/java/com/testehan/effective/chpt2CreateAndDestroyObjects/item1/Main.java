...
public class Main {
    public static void main(String[] args) {
        System.setProperty("MyServiceImplementation","com.testehan.effective.chapter2.item1.MyService1Impl");

        MyService myService = MyServiceFactory.newInstance();
...
• instance or getInstance—Returns an instance that is described by its parameters (if any) but cannot be said to have the
